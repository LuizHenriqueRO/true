            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="https://wa.me/5561994191756" className="text-sky-600 hover:underline font-medium">(61) 9 9419-1756</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:alessandro@grimpass.com" className="text-sky-600 hover:underline font-medium">alessandro@grimpass.com</a>
                </div>
              </div>
