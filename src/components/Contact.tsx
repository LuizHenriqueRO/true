    ...
    <section id="contato" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg font-bold text-slate-900">Horário de Atendimento</h4>
                  <p className="text-slate-600">Seg. à Qui. das 8hs às 17hs</p>
                  <p className="text-slate-600">Sex. das 8hs às 12hs</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg font-bold text-slate-900">Telefone / WhatsApp</h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600">Rua 29 Quadra 54 Lote 01, Sn Sala 403<br/>Parque Esplanada III, CEP 72876-354<br/>1066-GO</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Form */}
          <div className="bg-sky-50 p-8 sm:p-10 rounded-2xl shadow-sm border border-sky-100 h-fit">
            <h3 className="text-2xl font-bold text-slate-900 mb-6">Solicite uma Simulação</h3>
            <form className="space-y-6">
              ...
              <div>
                <label htmlFor="objective" className="block text-sm font-medium text-slate-700 mb-1">Objetivo</label>
                <select 
                  id="objective" 
                  defaultValue=""
                  className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all bg-white text-slate-700"
                >
              ...
              <button 
                type="button"
                className="w-full flex justify-center py-4 px-4 border border-transparent rounded-lg shadow-sm text-base font-bold text-white bg-primary hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-all duration-300 transform hover:-translate-y-1"
              >
                Enviar Solicitação
              </button>
            </form>
