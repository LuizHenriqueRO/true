    ...
    <>
      ...
      <section className="relative bg-white py-16 lg:py-24 overflow-hidden border-b border-slate-100">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 right-0 w-96 h-96 rounded-full bg-sky-50 blur-3xl opacity-50" />
          <div className="absolute bottom-0 left-0 w-72 h-72 rounded-full bg-sky-100/30 blur-3xl" />
        </div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 tracking-tight leading-tight mb-8 animate-fade-in-up animation-delay-100">
            ...
            <p className="text-lg md:text-2xl text-slate-600 mb-12 leading-relaxed animate-fade-in-up animation-delay-200">
