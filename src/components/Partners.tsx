export function Partners() {
  ...
  return (
    <section id="parceiros" className="py-20 bg-gray-50 border-t border-b border-gray-100 overflow-hidden">
      ...
      <div className="relative w-full flex overflow-hidden">
        ...
        <div className="flex animate-marquee whitespace-nowrap py-4">
          {[...partners, ...partners, ...partners].map((partner, index) => (
            <div 
              key={index} 
              className="mx-8 px-6 py-4 bg-white border border-gray-100 rounded-xl shadow-sm text-gray-500 font-bold text-lg min-w-[200px] text-center"
            >
              {partner}
            </div>
          ))}
