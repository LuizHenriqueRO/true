...
export function Features() {
  ...
  return (
    <section id="diferenciais" className="py-20 bg-gray-50 border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="w-14 h-14 bg-gray-50 rounded-xl flex items-center justify-center mb-6 group-hover:bg-primary/5 transition-colors duration-300">
                <feature.icon className="w-7 h-7 text-gray-700 group-hover:text-primary transition-colors duration-300" />
              </div>
